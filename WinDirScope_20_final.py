...
APP_VERSION = "1.4.1"  # envoi par mail via PowerShell+Outlook, sans pywin32
...
class WinDirScopeApp:
    ...
    def _open_email_with_attachment(self, filepath: Path):
        ...
        Sous Windows : utilise PowerShell + COM Outlook.
        Sinon : affiche juste l'emplacement du fichier.
        """
        if os.name != "nt":
            messagebox.showinfo(
                "Fichier prêt",
        ...
        try:
            ...
            messagebox.showinfo(
                "Fichier prêt",
                f"Le rapport a été généré :\n{filepath}\n\n"
                "Impossible d'ouvrir automatiquement un nouveau message Outlook.\n"
