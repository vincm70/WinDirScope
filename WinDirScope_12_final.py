...
def open_folder_in_explorer(path: Path):
    """Ouvre le dossier contenant 'path' dans l'explorateur de fichiers (non utilisé ici)."""
...
class WinDirScopeApp:
    ...
    def _export_html(self, filepath: Path):
        ...
        # Script JS pour filtres nom + niveau (version corrigée)
        html_parts.append("""
<script>
(function() {
  ...
  function applyFilters() {
    ...
    // 1) Calculer pour chaque noeud s'il matche le filtre
